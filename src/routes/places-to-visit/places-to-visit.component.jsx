...
const PlacesToVisit = () => {
    return (
        <div className="places-to-visit-section">
            <Navbar />
            <HeroSection title={"Discover Hidden Gems Across India"} description={"From timeless heritage sites to breathtaking landscapes, explore the must-visit destinations that make every journey unforgettable"} cta={"Start your plan"} bgImage={"img/places_to_visit.png"} />
